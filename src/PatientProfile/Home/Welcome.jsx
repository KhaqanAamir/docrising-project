    ...
    <div className='main-div'>
        <div className='img-div'>
            ...
            <div className="details-div">
                <h1 style={{fontSize:'40px', marginBottom:'5px'}}>Welcome to DocRising {patient.FullName}</h1>
                ...
                <button><Link style={{color:'white'}} to='/patientprofile/patient-applicationform'>Get Treatment Today</Link></button>            </div>
    </div>
  )
}
